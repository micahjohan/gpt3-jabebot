...
start_sequence_name = os.getenv("START_SEQUENCE")
restart_sequence_name = os.getenv("RESTART_SEQUENCE")
session_prompt_text = os.getenv("SESSION_PROMPT")
...
start_sequence = start_sequence_name
restart_sequence = restart_sequence_name
